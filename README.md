...
На тачскрине после входа в комнату появляется левый виртуальный стик и правая кнопка выстрела. Стик поворачивает корабль по горизонтали и включает тягу при движении вверх.
